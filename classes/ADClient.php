...
class ADClient extends Client
{
    ...
    protected $groupHierarchyCache = null;

    public function getGroupHierarchyCache()
    {
        if ($this->groupHierarchyCache === null) {
            if (!$this->autoAuth()) return null;
            $this->groupHierarchyCache = new GroupHierarchyCache($this->ldap);
        }
        return $this->groupHierarchyCache;
    }
